...
const Settings = () => {
                                ...
                                {["Documents", "Pictures", "Videos", "Audio", "Other"].map((type, i) => {
                                    ...
                                    return (
                                        <View key={i} className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: current?.dark + "08" }}>
                                            <Text value={type} />
                                            <Text value={`${size.toFixed(2)} GB`} size="sm" className="opacity-60" />
                                        </View>
                                    )
                                })}
                            </View>
    ...
    return (
        <>
            <View className="h-full flex flex-row" style={{ backgroundColor: current?.background }}>
                {/* Sidebar */}
                <View 
                    className="w-64 flex-shrink-0 border-r p-6 flex flex-col gap-2 overflow-auto"
                    style={{ 
                ...
                >
                    <View className="flex items-center gap-3 mb-6">
                        ...
                        />
                        <Text value="Settings" className="font-semibold text-xl" />
                    </View>
                ...
                {/* Main Content */}
                <View className="flex-1 overflow-auto p-8" style={{ backgroundColor: current?.background }}>
                    {renderContent()}
                </View>
            </View>
